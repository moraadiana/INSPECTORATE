<%@ Page Language="C#" Title="Transport Requisition" MasterPageFile="~/pages/Main.Master" AutoEventWireup="true" CodeBehind="TransportRequiz.aspx.cs" Inherits="INSPECTORATEStaff.pages.TransportRequiz" %>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="atext">Nature of the Trip</label>
                                                <div class="icon-after-input">
                                                    <asp:DropDownList ID="ddlNature" class="form-control select2" runat="server">
                                                        <asp:ListItem Value="1">Academic</asp:ListItem>
                                                        <asp:ListItem Value="2">Administrative</asp:ListItem>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="atext2">Group:</label>
                                                <div class="icon-after-input">
                                                    <asp:DropDownList ID="ddlGroup" class="form-control select2" runat="server"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
