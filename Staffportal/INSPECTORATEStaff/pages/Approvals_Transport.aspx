<%@ Page Language="C#" Title="Transport Approvals" MasterPageFile="~/pages/Main.Master" AutoEventWireup="true" CodeBehind="Approvals_Transport.aspx.cs" Inherits="INSPECTORATEStaff.pages.Approvals_Transport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Transport Approvals
       
                <%--<small>Version 2.0</small>--%>
            </h1>
            <ol class="breadcrumb">
                <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                <li class="active">Transport Approvals</li>
            </ol>
        </section>
                        ...
                        <asp:View ID="View1" runat="server">
                            <div class="box box-success box-solid">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Pending Transport Approvals</h3>
                                </div>
                                <div class="box-body">
                                    <asp:GridView ID="gvLeaveApprovals" runat="server" AllowPaging="true" AutoGenerateColumns="false"
                                        DataKeyNames="Document No_" EmptyDataText="You have no Transport Approvals" ShowHeaderWhenEmpty="true"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Transport Requisition No" HeaderText="Ref No" ItemStyle-CssClass="text-uppercase"
                                                ReadOnly="true" />
                                            <asp:BoundField DataField="Commencement" HeaderText="Commencement" ItemStyle-CssClass="text-uppercase"
                                                ReadOnly="true" />
                                            <asp:BoundField DataField="Destination" HeaderText="Destination" ItemStyle-CssClass="text-uppercase"
                                                ReadOnly="true" />
                                            <asp:BoundField DataField="Date of Request" HeaderText="Date of Request" DataFormatString="{0:dd/MM/yyyy}" ReadOnly="true" />
                                            <%-- <asp:BoundField DataField="Applied Days" HeaderText="Days applied" ItemStyle-CssClass="text-capitalize"
                                                            Visible="false" ReadOnly="true" />--%>
                                            <asp:BoundField DataField="Date of Trip" HeaderText="Date of Trip" DataFormatString="{0:dd/MM/yyyy}"
                                                ReadOnly="true" />
                                            <%-- <asp:BoundField DataField="End Date" HeaderText="End date" DataFormatString="{0:dd/MM/yyyy}"
                                                            ReadOnly="true" />--%>
                                            <asp:BoundField DataField="Purpose of Trip" HeaderText="Comments" ItemStyle-CssClass="text-capitalize"
                                                ReadOnly="true" />
                                            <asp:BoundField DataField="No of Days Requested" HeaderText="No of Days Requested" ItemStyle-CssClass="text-uppercase"
                                                ReadOnly="true" />
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header padding-10">
                                            ...
                                            <h5 class="modal-title">Transport Application Details</h5>
                                        </div>
