<%@ Page Language="C#" Title="Imprest Approvals" MasterPageFile="~/pages/Main.Master" AutoEventWireup="true" CodeBehind="Approvals_Imprest.aspx.cs" Inherits="INSPECTORATEStaff.pages.Approvals_Imprest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Imprest Approvals
       
                <%--<small>Version 2.0</small>--%>
            </h1>
            <ol class="breadcrumb">
                <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                <li class="active">Imprest Approvals</li>
            </ol>
        </section>
                        ...
                        <asp:View ID="View1" runat="server">
                            <div class="box box-success box-solid">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Pending Imprest Approvals</h3>
                                </div>
                                <div class="box-body">
                                    <asp:GridView ID="gvLeaveApprovals" runat="server" AllowPaging="true" AutoGenerateColumns="false"
                                        DataKeyNames="Document No_" EmptyDataText="You have no imprest Approvals" ShowHeaderWhenEmpty="true"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="No_" HeaderText="Imprest No" ItemStyle-CssClass="text-uppercase"
                                                ReadOnly="true" />
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header padding-10">
                                            ...
                                            <h5 class="modal-title">Imprest requisition Details</h5>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-6">
                                                    <div runat="server" id="dvSaveBooking" class="col-md-12">
                                                        <a runat="server" id="btnApprove" onserverclick="btnApprovelImprest"><span class="btn btn-success">
