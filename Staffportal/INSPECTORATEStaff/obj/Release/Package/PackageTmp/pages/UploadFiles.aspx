<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFiles.aspx.cs" MasterPageFile="~/pages/Main.Master"  Inherits="INSPECTORATEStaff.pages.UploadFiles" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Main1" runat="server">
    <div class="page-content" style="background-color:aliceblue;padding:10px;">
        <div class="page-header">
            <h1>INSPECTORATE UPLOAD Documents </h1>
        </div>
        <!-- /.page-header -->
