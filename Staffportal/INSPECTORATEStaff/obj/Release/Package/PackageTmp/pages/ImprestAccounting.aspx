<%@ Page Language="C#" Title="Imprest Accounting" MasterPageFile="~/pages/Main.Master" AutoEventWireup="true" CodeBehind="ImprestAccounting.aspx.cs" Inherits="INSPECTORATEStaff.pages.ImprestAccounting" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Main1" runat="Server">
    <div class="content-wrapper">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title">Imprest Accounting</h3>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="ddlImprests" class="form-control select2" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlImprests_SelectedIndexChanged"></asp:DropDownList>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label for="atext3">FIN-Imprest surrender details</label>
                        <div class="icon-after-input">
                            <asp:GridView ID="gvLines" AutoGenerateColumns="false" DataKeyNames="No" class="table table-responsive no-padding table-bordered table-hover" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Actual Amount" SortExpression="">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Cash Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtCash" runat="server" Text="" BorderColor="Blue" BorderStyle="Ridge" BorderWidth="2px" ForeColor="Blue" Width="100px" />
                                        </ItemTemplate>
                                        <ItemStyle Font-Bold="True" ForeColor="Green"></ItemStyle>
                                    </asp:TemplateField>
