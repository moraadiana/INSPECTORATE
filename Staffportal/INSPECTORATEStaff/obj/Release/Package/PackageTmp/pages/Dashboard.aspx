<%@ Page Language="C#" Title="Dashboard" MasterPageFile="~/pages/Main.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="INSPECTORATEStaff.pages.Dashboard" %>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-green">
                        ...
                        <div class="info-box-content">
                            ...
                            <a href="Approvals_Leave.aspx" class="small-box-footer white" style="color: white">View Requests <i class="fa fa-arrow-circle-right"></i></a>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-yellow">
                        ...
                        <div class="info-box-content">
                            ...
                            <a href="Approvals_Imprest.aspx" class="small-box-footer" style="color: white">View Requests <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-red">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><%=TotalTransport() %></span>

                            <div class="progress">
                                <div class="progress-bar" style="width: 70%"></div>
                            </div>
                            <a href="Approvals_Transport.aspx" class="small-box-footer white" style="color: white">View Requests <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-aqua">
                        ...
                        <div class="info-box-content">
                            ...
                            <a href="Approvals_Stores.aspx" class="small-box-footer white" style="color: white">View Requests <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                                    ...
                                    <ul class="list-group list-group-unbordered">
                                        ...
                                        <li class="list-group-item">
                                            <b>Postal Address:</b> <a class="pull-right">
                                                ...
                                                <asp:Label ID="LblPostalCode" runat="server" Text=""></asp:Label></a>
                                        </li>
                                    </ul>
                                    <div class="box-footer clearfix">
                                       <%-- <a href="Payslip.aspx" class="btn btn-sm btn-warning btn-flat pull-left">Payslip</a>
                                        <a href="pnineform.aspx" class="btn btn-sm btn-danger btn-flat">P9 Form</a>--%>
                                        <%--<a href="Changepassword.aspx" class="btn btn-sm btn-success btn-flat pull-right">Change password</a>--%>
                                    </div>
                                </div>
                            </div>
                            <!-- /.row -->
