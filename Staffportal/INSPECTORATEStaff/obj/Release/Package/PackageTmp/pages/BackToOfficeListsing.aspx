<%@ Page Language="C#" Title="Back To Office Listing" MasterPageFile="~/pages/Main.Master" AutoEventWireup="true" CodeBehind="BackToOfficeListsing.aspx.cs" Inherits="INSPECTORATEStaff.pages.BackToOfficeListsing" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <p class="text-center"><a class="btn btn-pill btn-info u-posRelative pull-left" href="BackToOffice.aspx"> Apply For Back To Office<span class="waves"></span> </a><a class="btn btn-pill btn-warning u-posRelative pull-right" href="LeaveStatements.aspx"><i class="fa fa-file-pdf-o"></i> My Leave Statement<span class="waves"></span> </a></p>
                            </div>
                            <br/>
                            <br/>
                            <br/>
                                    ...
                                    <table id="example1" class="table no-margin">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="small">Leave Number</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <%=Jobs()%>
