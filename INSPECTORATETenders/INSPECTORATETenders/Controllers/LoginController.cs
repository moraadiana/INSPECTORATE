using INSPECTORATETenders.Models;
using System;
...
namespace INSPECTORATETenders.Controllers
{
    public class LoginController : Controller
    {
        ...
        public void SendPasswordResetLink(string email)
        {
            try
            {
                ...
                string subject = "INSPECTORATE Tenders Account Password Reset";
                string body = $"Hello {bidderName};" +
                    $"<br/><br/>" +
                    $"Please follow the link below to reset your INSPECTORATE Tenders Account Password." +
                    $"<br/><br/>" +
