using INSPECTORATEJobs.Models;
using INSPECTORATEJobs.NAVWS;
...
namespace INSPECTORATEJobs.Controllers
{
    public class JobApplicationController : Controller
    {
        ...
        public ActionResult GeneralInformation(string jobId, string refNo)
        {
            ...
            string appliedJobs = webportals.GetMyApplications(username);
